...
#define SINK_INPUT_MAX 4
#define MODULE_ARGS_MAX 2048

#define PA_MODULE_COMBINE_SINK_NAME "module-combine-sink"
...
static void module_find_and_unload_combined_sink_cb(pa_context *c,
                                                    ...
                                                    int eol, void *userdata) {
    if (!eol && strcmp(i->name, PA_MODULE_COMBINE_SINK_NAME) == 0) {
    ...
    for (;;) {
        ...
        switch (pa_context_get_state(pa_ctx)) {
            case PA_CONTEXT_READY:
                ...
                expect(
                    op_finish_and_unref(pa_ctx, pa_ml,
                                        pa_context_load_module(
                                            pa_ctx, PA_MODULE_COMBINE_SINK_NAME,
                                            args, module_load_cb, NULL)) == 0);
